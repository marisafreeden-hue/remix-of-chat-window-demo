...
const TitleSlide: React.FC = () => (
  <div className="absolute inset-0 bg-white overflow-hidden">
    ...
    <div className="absolute right-[-80px] top-1/2 -translate-y-1/2 w-[500px] rounded-[1.5rem] overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.15),0_8px_24px_rgba(0,0,0,0.08)]">
